<template>
  <div class="row">
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#createModal">{{ $t('button.createPayment') }}</button>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="date">{{ $t('term.date') }}</label> <input type="text" class="form-control" id="date" v-model="form.date" autocomplete="off">
            ...
            <div class="form-group">
              <label for="paymentType">{{ $t('term.paymentType') }}</label> <input type="text" class="form-control" id="paymentType" v-model="form.paymentType" autocomplete="off">
              <div class="text-danger" v-if="formResult.validationErrorsByField && formResult.validationErrorsByField.paymentType">
                <p v-for="errorCode in formResult.validationErrorsByField.paymentType" :key="errorCode">{{ $t(errorCode) }}</p>
              </div>
            </div>

            <div class="form-group">
              <label for="price">{{ $t('term.price') }}</label> <input type="text" class="form-control" id="price" v-model="form.price" autocomplete="off">
