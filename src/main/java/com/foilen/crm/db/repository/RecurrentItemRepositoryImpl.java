...
public class RecurrentItemRepositoryImpl extends AbstractRepositoryCustom implements RecurrentItemRepositoryCustom {
    ...
    @Override
    public Page<RecurrentItem> findAllSortedByClientName(Pageable pageable) {
        ...
        return aggregation(RecurrentItem.class, RecurrentItem.class, pageable, List.of(lookupStage, unwindStage, addFieldsStage, sortStage));
    }
