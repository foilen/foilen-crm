...
cp -v $RUN_PATH/src/main/resources/WEB-INF/crm/web/js/vendor/package.json $BUILD_PATH/
...
DEST_PATH=$RUN_PATH/src/main/resources/WEB-INF/crm/web/js/vendor/dist
rm -rfv $DEST_PATH
mkdir -p $DEST_PATH
